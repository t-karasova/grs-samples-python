...
def get_predict_request(_page_size: int, _page_token: str):
    predict_placement = (
    ...
    predict_request.page_size = _page_size
    predict_request.page_token = _page_token
...
def predict():
    ...
    response = PredictionServiceClient(client_options=predict_client_options).predict(
        get_predict_request(_page_size, _page_token)
    )
