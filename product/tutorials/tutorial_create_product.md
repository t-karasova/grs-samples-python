...
1. Open the <walkthrough-editor-select-regex filePath="cloudshell_open/grs-samples-python/product/create_product.py" regex="# generate product to create">create_product.py</walkthrough-editor-select-regex> code sample and check this product generation with the method ```generate_product()```.
